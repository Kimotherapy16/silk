...
var _supabaseClientJsDefault = parcelHelpers.interopDefault(_supabaseClientJs);
document.addEventListener("DOMContentLoaded", function() {
    ...
    loginForm.addEventListener("submit", async function(e) {
        ...
        const { user, error } = await (0, _supabaseClientJsDefault.default).auth.signInWithPassword({
            email,
            password
        });
        if (error) alert("Error logging in: " + error.message);
        else window.location.href = "dashboard.html"; // Redirect to dashboard after successful login
    });
    // Handle signup
    signupForm.addEventListener("submit", async function(e) {
        ...
        const { user, error } = await (0, _supabaseClientJsDefault.default).auth.signUp({
            email,
            password
        });
...
},{"./supabaseClient.js":"gVhkt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gVhkt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
